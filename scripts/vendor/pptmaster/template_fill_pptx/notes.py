...
# Stub: svg_to_pptx is not vendored (notes are not used by PaperDeck)
try:
    from svg_to_pptx.pptx_notes import create_notes_slide_xml, markdown_to_plain_text
except ImportError:
    def create_notes_slide_xml(slide_number, text):
        return f'<?xml version="1.0"?><p:notes xmlns:p="http://schemas.openxmlformats.org/presentationml/2006/main"/>'
